...
contentParts:
    - title: Cold Air Intakes
      description: easy mods but big results.  Changing the Air Intake can add felt power and response that we all expected to get from the factory.
    - title: Exhaust
      description: Truck or Vehicle sound like a desk fan.  Adding exhaust will make your rig sound better for sure, but added looks and performance are worth every penny
    - title: Gear Ratio Upgrades
      description: went too big on the tires.  No problem, we can make a gear ratio change and get your power and torque back.  Let us help find the right ration and best gears to get that done.
    - title: Superchargers
      description: Want to add the absolute most power to your rig.  Let us find a power solution to your vehicle.  With application specific bolt on supercharger kits available, getting extra power may be easier than you think.
    - title: Tuners and Programming
      description: with all the changes we make to trucks and suvs, making the changes to tell the vehicle what to do is very important.  Making some small programming changes by software or by utilizing a specific tuner for your vehicle will ensure the modifications you added wool perform like they are supposed to.
...
logo: Tachometer
featured: shop/2022-12-05/shop-shoot_30.jpg
